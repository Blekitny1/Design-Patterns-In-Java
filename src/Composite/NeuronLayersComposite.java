...
//    }
    ...
    public Iterator<Neuron> iterator() {
        return Collections.singleton(this).iterator(); //masquerade single neuron as a Collection of singleton
    }
...
public class NeuronLayersComposite {
    public static void main(String[] args) {
        ...
        neuron.connectTo(layer);//we want this ways of connectTo too
