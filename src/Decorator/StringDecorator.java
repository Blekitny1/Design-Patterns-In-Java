...
//class MagicString extends String {} does not work, since String is final
class MagicString {
    ...
    public long getNumberOfVowels() {
        return string.chars().mapToObj(c -> (char)c).filter(c -> "aeiouy".contains(c.toString())).count();
    }
...
public class StringDecorator {
    public static void main(String[] args) {
        ...
        System.out.println(ms.getNumberOfVowels());
    }
}
